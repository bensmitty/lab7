...
var getProducts = function getProducts(callback) {
    ...
    //Ben 11/18/15 - updated query to include rating from products
    var sql = 'SELECT csc443.products.id , csc443.products.name, csc443.products.price , CAST(AVG(csc443.ratings.rating)AS decimal(3,2)) AS \'rating\', csc443.products.image FROM csc443.products LEFT JOIN csc443.ratings ON csc443.products.id = csc443.ratings.product_id GROUP BY csc443.products.id';
